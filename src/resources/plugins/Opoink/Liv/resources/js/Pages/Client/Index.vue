		...
		<div class="container">
			...
			<div class="row mb-5">
				...
				<div class="col-6">
					...
					<div class="card">
						<div class="card-body">
							<a class="title d-flex align-items-center text-decoration-none text-dark mb-3" href="https://vuejs.org/" target="_blank">
								...
								<p class="mb-0 fs-4 ms-3">VueJS</p>
							</a>
							<p>
			...
			<div class="row">
				<div class="col-12">
					<p class="mb-0 text-center">Oliv v{{ props.propsdata.oliv_version }}</p>
					<!-- <p class="mb-0 text-center">Laravel v{{ props.propsdata.laravel_version }} (PHP v{{ props.propsdata.php_version }})</p> -->
					<!-- <p class="mb-0 text-center">Inertia v{{ props.propsdata.inertiajs_version }}</p> -->
				</div>
			</div>
		</div>
	</div>
